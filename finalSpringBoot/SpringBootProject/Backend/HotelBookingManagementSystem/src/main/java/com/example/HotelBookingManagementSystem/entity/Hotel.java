...
public class Hotel {
    ...
    public Hotel(long id, String name, String address, String rating, String image, Location location, HotelAdmin hotelAdmin, List<Room> rooms, List<Booking> bookings) {
        this.id = id;
        this.name = name;
